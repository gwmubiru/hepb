...
app_name = 'worksheets'
urlpatterns  = [
	url(r'^create/(?P<machine_type>[A|R|C|H])$', login_required(views.create), name='create'),
	...
	url(r'^authorize_list/(?P<machine_type>[A|R|C|H])/$', login_required(views.authorize_list), name='authorize_list'),
	...
	url(r'^reg_info/(?P<machine_type>[A|R|C|H])/$', login_required(views.reg_info), name='reg_info'),
