...
urlpatterns  = [
	...
	re_path(r'^samples_with_issues/$', login_required(views.samples_with_issues), name='samples_with_issues'),
	re_path(r'^samples_with_issues/add/$', login_required(views.add_sample_with_issue), name='add_sample_with_issue'),
	re_path(r'^samples_with_issues/export/$', login_required(views.samples_with_issues_export), name='samples_with_issues_export'),
	re_path(r'^samples_with_issues/(?P<issue_id>[0-9]+)/edit/$', login_required(views.edit_sample_with_issue), name='edit_sample_with_issue'),
	re_path(r'^samples_with_issues/(?P<issue_id>[0-9]+)/delete/$', login_required(views.delete_sample_with_issue), name='delete_sample_with_issue'),
	re_path(r'^samples_with_issues/(?P<issue_id>[0-9]+)/retrieve/$', login_required(views.retrieve_sample_with_issue), name='retrieve_sample_with_issue'),
